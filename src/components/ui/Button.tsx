...
export function Button({
  ...
  const variants = {
    primary:
      "bg-gradient-to-r from-pink-dark to-pink text-white hover:from-pink hover:to-pink-dark hover:shadow-[0_0_24px_rgba(201,75,108,0.25)] hover:-translate-y-[2px] hover:scale-[1.02] delay-100",
    secondary:
