...
interface LearningMultipleChoiceAnswerProps {
	activity: Activity;
...
const LearningMultipleChoiceAnswer: React.FC<LearningMultipleChoiceAnswerProps> = ({
	activity,
	selectedAnswer,
	showFeedback,
	isCorrect,
	...
	if (!activity || !activity.options || !Array.isArray(activity.options)) {
		console.error("[LearningMultipleChoiceAnswer] Invalid activity options:", activity);
...
export default LearningMultipleChoiceAnswer;
